#ifndef __USER_HISTOGRAM_H__
#define __USER_HISTOGRAM_H__

//#include "preprocess.hpp"
#include "detect.hpp"


Mat make_palate(int rows)
{
...
{
    Mat hsv_platte = make_palate(hist.rows);
...
vector<Mat> cals_coin_histo(vector<Mat> coins, int hue_bin)
{
    vector<Mat> histo;
